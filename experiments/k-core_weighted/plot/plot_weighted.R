...
perf_comp_factors <- c(ilp_bname, it0_bname, it1_bname, tight_bname)
...
time_segments <- segments_my_mem #segments_default # time_segments_adil
cut_segments <- segments_my_mem #segments_cut # cut_segments_adil
...
open_dev("perf_kcore_w", width = 7 / 1.05, tex = TEX)
egg::ggarrange(
...
dev_off()
open_dev("perf_kcore_w_legend", width = 7 / 1.05, tex = TEX)
egg::ggarrange(
