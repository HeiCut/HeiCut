...
echo "=== Step 1: Generating medium unweighted experiments ==="
./generate_experiments.sh
echo "Experiments generated successfully."
echo

echo "=== Step 2: Running medium unweighted experiments ==="
./run_experiments.sh -n 1
echo "Experiments finished running."
echo

echo "=== Step 3: Extracting medium unweighted results ==="
./extract_results.sh
echo "Results extracted successfully."
echo

echo "=== medium unweighted pipeline completed successfully ==="
